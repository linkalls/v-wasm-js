...
**VitrioはすべてのメトリクスでReactを上回る：**

| 指標 | Vitrio | SolidJS | React |
|------|--------|---------|-------|
| バンドルサイズ | 8KB | 13KB | 144KB |
| 100クリック (ms) | **16.53** | 16.56 | 25.80 |
| リスト更新 (ms) | **15.50** | 18.47 | 18.96 |

> 📊 詳細は [benchmarks/results.md](./benchmarks/results.md) を参照
